...
public class EmailCampaignsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call getEmailCampaignsCall(String type, String status, String statistics, String startDate, String endDate, Long limit, Long offset, String sort, Boolean excludeHtmlContent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private Call getEmailCampaignsValidateBeforeCall(String type, String status, String statistics, String startDate, String endDate, Long limit, Long offset, String sort, Boolean excludeHtmlContent, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        Call call = getEmailCampaignsCall(type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent, progressListener, progressRequestListener);
        return call;
    ...
    public GetEmailCampaigns getEmailCampaigns(String type, String status, String statistics, String startDate, String endDate, Long limit, Long offset, String sort, Boolean excludeHtmlContent) throws ApiException {
        ApiResponse<GetEmailCampaigns> resp = getEmailCampaignsWithHttpInfo(type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetEmailCampaigns> getEmailCampaignsWithHttpInfo(String type, String status, String statistics, String startDate, String endDate, Long limit, Long offset, String sort, Boolean excludeHtmlContent) throws ApiException {
        Call call = getEmailCampaignsValidateBeforeCall(type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call getEmailCampaignsAsync(String type, String status, String statistics, String startDate, String endDate, Long limit, Long offset, String sort, Boolean excludeHtmlContent, final ApiCallback<GetEmailCampaigns> callback) throws ApiException {
        ...
        Call call = getEmailCampaignsValidateBeforeCall(type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetEmailCampaigns>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

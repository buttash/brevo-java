...
public class Body13 {
  ...
  public Body13 visitorId(String visitorId) {
  ...
  **/
  ...
  public Body13 text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public Body13 agentId(String agentId) {
   ...
   * @return agentId
  **/
  @ApiModelProperty(example = "PjRBMhWGen6aRHjif", value = "agent ID. It can be found on agent’s page or received <a href=\"https://developers.brevo.com/docs/conversations-webhooks\">from a webhook</a>. Optional if `groupId` is set.")
  ...
  public Body13 groupId(String groupId) {
  ...
  **/
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.visitorId, body13.visitorId) &&
    ObjectUtils.equals(this.text, body13.text) &&
    ObjectUtils.equals(this.agentId, body13.agentId) &&
    ObjectUtils.equals(this.groupId, body13.groupId);
  }

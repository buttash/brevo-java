...
public class Body11 {
  ...
  public Body11 visitorId(String visitorId) {
  ...
  **/
  ...
  public Body11 text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public Body11 agentId(String agentId) {
   ...
   * @return agentId
  **/
  @ApiModelProperty(example = "d9nKoegKSjmCtyK78", value = "agent ID. It can be found on agent’s page or received <a href=\"https://developers.brevo.com/docs/conversations-webhooks\">from a webhook</a>. Alternatively, you can use `agentEmail` + `agentName` + `receivedFrom` instead (all 3 fields required).")
  ...
  public Body11 receivedFrom(String receivedFrom) {
  ...
  **/
  ...
  public Body11 agentEmail(String agentEmail) {
  ...
  **/
  ...
  public Body11 agentName(String agentName) {
  ...
  **/
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.visitorId, body11.visitorId) &&
    ObjectUtils.equals(this.text, body11.text) &&
    ObjectUtils.equals(this.agentId, body11.agentId) &&
    ObjectUtils.equals(this.receivedFrom, body11.receivedFrom) &&
    ObjectUtils.equals(this.agentEmail, body11.agentEmail) &&
    ObjectUtils.equals(this.agentName, body11.agentName);
  }

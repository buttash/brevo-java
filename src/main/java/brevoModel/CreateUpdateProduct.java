...
public class CreateUpdateProduct {
  ...
  **/
  ...
  public CreateUpdateProduct metaInfo(Map<String, String> metaInfo) {
    this.metaInfo = metaInfo;
    return this;
  }

  public CreateUpdateProduct putMetaInfoItem(String key, String metaInfoItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(id, name, url, imageUrl, sku, price, categories, parentId, metaInfo, updateEnabled, deletedAt);
  }

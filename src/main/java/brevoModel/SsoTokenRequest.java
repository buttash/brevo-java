...
public class SsoTokenRequest {
  ...
  **/
   ...
   * @return email
  **/
  @ApiModelProperty(example = "vipin+subaccount@brevo.com", value = "User email of sub-account organization")
  ...
  **/
  ...
  public SsoTokenRequest url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @ApiModelProperty(example = "https://app.brevo.com/senders/domain/list", value = "Set the full target URL after login success. The user will land directly on this target URL after login")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    ObjectUtils.equals(this.url, ssoTokenRequest.url);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(id, email, target, url);
  }

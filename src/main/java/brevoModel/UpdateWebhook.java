...
public class UpdateWebhook {
  ...
  **/
  ...
  public UpdateWebhook auth(GetWebhookAuth auth) {
    this.auth = auth;
    return this;
  }
  ...
  **/
  ...
  public UpdateWebhook headers(List<GetWebhookHeaders> headers) {
    this.headers = headers;
    return this;
  }

  public UpdateWebhook addHeadersItem(GetWebhookHeaders headersItem) {
  ...
  **/
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    ObjectUtils.equals(this.domain, updateWebhook.domain) &&
    ObjectUtils.equals(this.batched, updateWebhook.batched) &&
    ObjectUtils.equals(this.auth, updateWebhook.auth) &&
    ObjectUtils.equals(this.headers, updateWebhook.headers);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(url, description, events, domain, batched, auth, headers);
  }

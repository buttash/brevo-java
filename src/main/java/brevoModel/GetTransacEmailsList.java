...
public class GetTransacEmailsList {
  ...
  **/
  ...
  public GetTransacEmailsList addTransactionalEmailsItem(GetTransacEmailsListTransactionalEmails transactionalEmailsItem) {
    if (this.transactionalEmails == null) {
      this.transactionalEmails = new ArrayList<GetTransacEmailsListTransactionalEmails>();
    }
  ...
  **/
  ...
  public void setTransactionalEmails(List<GetTransacEmailsListTransactionalEmails> transactionalEmails) {
    this.transactionalEmails = transactionalEmails;
  }

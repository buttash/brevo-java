...
public class CreateUpdateBatchCategoryModel {
   ...
   * @return createdCount
  **/
  @ApiModelProperty(example = "7", value = "Number of the new created categories")
   ...
   * @return updatedCount
  **/
  @ApiModelProperty(example = "5", value = "Number of the existing categories updated")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.createdCount, createUpdateBatchCategoryModel.createdCount) &&
    ObjectUtils.equals(this.updatedCount, createUpdateBatchCategoryModel.updatedCount);
  }

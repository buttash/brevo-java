...
public class GetSharedTemplateUrl {
   ...
   * @return sharedUrl
  **/
  @ApiModelProperty(example = "https://my.brevo.com/pt2YU7R5W_guXlowgumy_VX4pFsKu._zd0Gjj96x1_GMmzc1Qps5ZIpj6nx-", required = true, value = "A unique URL for the email campaign or transactional template. This URL can be shared with other Brevo users.")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.sharedUrl, getSharedTemplateUrl.sharedUrl);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(sharedUrl);
  }

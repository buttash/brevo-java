...
public class GetEmailEventReport {
  ...
  public GetEmailEventReport events(List<GetEmailEventReportEvents> events) {
    this.events = events;
    return this;
  }

  public GetEmailEventReport addEventsItem(GetEmailEventReportEvents eventsItem) {
    if (this.events == null) {
      this.events = new ArrayList<GetEmailEventReportEvents>();
    }
  ...
  **/
  ...
  public void setEvents(List<GetEmailEventReportEvents> events) {
    this.events = events;
  }

...
public class CreatedBatchId {
   ...
   * @return batchId
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Batch ID of the request")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.batchId, createdBatchId.batchId);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(batchId);
  }

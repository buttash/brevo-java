...
public class SendTestSms {
   ...
   * @return phoneNumber
  **/
  @ApiModelProperty(example = "33689965433", value = "Mobile number of the recipient with the country code. This number must belong to one of your contacts in Brevo account and must not be blacklisted")

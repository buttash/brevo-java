...
import brevo.auth.HttpBasicAuth;
import brevo.auth.OAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String defaultUserAgent = "brevo_clientAPI/v1.0.0/java";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.brevo.com/v3
    ...
    public ApiClient setUserAgent(String userAgent) {
        if (userAgent.toLowerCase().startsWith("brevo_"))

...
public class EmailCampaignsApiTest {
    ...
    public void getEmailCampaignsTest() throws ApiException {
        ...
        Long offset = null;
        String sort = null;
        Boolean excludeHtmlContent = null;
        GetEmailCampaigns response = api.getEmailCampaigns(type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent);
